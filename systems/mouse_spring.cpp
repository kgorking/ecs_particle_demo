...
static ecs::system_base & mouse_spring = ecs::make_parallel_system([](velocity& vel, particle const& par, frame_context const& fc) {
...
static ecs::system_base const& toggle_mouse_spring = ecs::make_system([](input const& input) {
