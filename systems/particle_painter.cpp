...
void setup_particle_painter() {
	...
	ecs::system_base & particle_painter = ecs::make_parallel_system([](particle& par, frame_context const& fc) {
	...
	ecs::make_system([&particle_painter](input const& input) mutable {
